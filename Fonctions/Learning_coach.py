...
import Fonctions.Decimaux
import Fonctions.Fractions
import Fonctions.GrandsNombres
...
def Learning_coach(CSV_notes) :
    ...
    for liste in liste_du_reader :
        ...
        Fonctions.Decimaux.CompleterDecimaux(liste,plan_perso)
        Fonctions.GrandsNombres.CompleterGrandsNombres(liste,plan_perso)
        Fonctions.Fractions.CompleterFractions(liste,plan_perso)
